  ...
  return (
    <div style={{ padding: '2vh 3vw' }}>
      ...
      <p>
        ...
        conditions of your use of the “Telegram to Notion Bot” mobile
        ...
        agreement and may not access and use the Mobile Application and
        ...
        is not physically signed by you, and it governs your use of the Mobile
        Application and Services. This terms and conditions policy was created
      ...
      <p>
        You must be at least 16 years of age to use the Mobile Application and
        Services. By using the Mobile Application and Services and by agreeing
        to this Agreement you warrant and represent that you are at least 16
        years of age.
      </p>
      <p>
        ...
        and start using the Services. Providing false contact information of any
      ...
      <p>
        ...
        procedural laws of Argentina without regard to its rules on conflicts or
        choice of law and, to the extent applicable, the laws of Argentina. The
        exclusive jurisdiction and venue for actions related to the subject
        matter hereof shall be the courts located in Argentina, and you hereby
